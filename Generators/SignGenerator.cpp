...
bool SignGenerator::LoadModels(ModelManager* modelManager)
{
    ...
    signArchetypes.push_back(SignInternal(PhysicsGenerator::CShape::SIGN_STOP, modelId));

    return true;
}

std::map<PhysicsGenerator::CShape, const std::vector<glm::vec3>*> SignGenerator::GetModelPoints(ModelManager* modelManager)
{
...
void SignGenerator::GetRandomSignModel(unsigned int* modelId, PhysicsGenerator::CShape* shape) const
{
